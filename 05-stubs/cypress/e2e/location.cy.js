...
describe('share location', () => {
  beforeEach(() => {
    cy.clock(); // let Cypress know that we're gonna manipulate the clock somewhere in the test
  ...
  it('should fetch the user location', () => {
    ...
    // button is disabled while fetching, then removed when done
  ...
  it('should share a location URL', () => {
    ...
    cy.tick(2000); // by using cy.Clock(), now we can skip 2 seconds
